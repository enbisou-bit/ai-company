...
- **Git・反映**：Code commit **8cde936**・docs commit（本更新）・Annotated Tag **v1.01-affiliate-revenue-intelligence**・**main push・Render反映**・**iPhone実機確認待ち**。保護対象4件は未stage・未commit。**Decision 078**。
