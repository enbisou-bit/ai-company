...
- **Git・反映**：Code commit 28fa51c/1d04f31/3ef7495・docs commit（本更新）・Annotated Tag **v1.01-affiliate-product-intelligence-persistence**・**main push・Render反映**・**iPhone実機確認はユーザー実施**。保護対象4件は未stage・未commitで保護。**Decision 077**。
