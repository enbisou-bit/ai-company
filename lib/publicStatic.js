...
const PUBLIC_FILES = Object.freeze([
  ...
  // CV-4c-3: Content Evidence Approval UI が読み込む browser-safe module。
  //   ★ shared/contentEvidence.js 自体（Evidence trust/verification の実判定ロジック）は
  //     引き続き非公開のまま（このファイルは server-only 依存を lazy化し、
  //     ブラウザでは Claim Intent / Safety Filter / Query Plan の機能のみが動作する設計）。
